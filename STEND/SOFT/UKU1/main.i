...
long tempL;
 ...
 if(a_ind . i==iMn)
	...
	ptrs[3]=			" ”ÒÚ‡ÌÓ‚Í‡ ‚ÂÏÂÌË  ";
	ptrs[4]=			"  ÓÌÚÓÎ¸ ËÌÚÂÙÂÈÒ‡";
    ptrs[5]=			"  ÓÌÚÓÎ¸ ÓÔÚÓÌÓ‚  ";
	ptrs[6]=			" ƒ‡Ú˜ËÍ ‚ÓÁ‰Ûı‡     ";
	ptrs[7]=			" ƒ‡Ú˜ËÍ ‚Ó‰˚        ";	
	ptrs[8]=			" œÓ·Ì‡ˇ ÒÏÒ        ";
	ptrs[9]=			" “ÂÒÚ ‚˚ÍÎ˛˜ÂÌËˇ    ";
	ptrs[10]=			" «‡‚Ó‰ÒÍËÂ ÛÒÚ‡ÌÓ‚ÍË";						
...
if(but==249)
	...
	{
	signed char temp;
	if((but==239)&&(a_ind . s_i>=0)&&(a_ind . s_i<=5))
		{
		a_ind . s_i++;
		gran_char(&a_ind . s_i,0,5);
		}
	else if((but==247)&&(a_ind . s_i>=0)&&(a_ind . s_i<=5))
		{
		a_ind . s_i--;
		gran_char(&a_ind . s_i,0,5);
		}
		...
		{
		if((a_ind . s_i>=0)&&(a_ind . s_i<=5))a_ind . s_i=10;
		else a_ind . s_i=0;
		speed=0;
		}			
	else if(a_ind . s_i==0)
